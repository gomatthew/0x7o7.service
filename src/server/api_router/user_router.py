...
from src.server.service import user_register, get_userinfo, user_logout, reset_password, send_verify_code
from src.server.utils import token_identify

user_router = APIRouter(prefix="/user", tags=["用户类api"])
user_router.post("/send_verify_code")(send_verify_code)
